 ...
 * @author Alisher
 */
public class SelectionComponentsPage extends BasePage {
    ...
    /* Section 7.4.1 */
        ...
        add(new ListChoice("category1", new PropertyModel(cheese,
                "category"), categories));
        ...
        add(new RadioChoice("category3", new PropertyModel(cheese,
                "category"), categories).setSuffix(" "));

    /* Section 7.4.2 */
        List<String> choices = Arrays.asList("Camel", "Cow", "Goat",
                "Reindeer", "Sheep", "Yak");
        add(new ListMultipleChoice("milkTypes1", new PropertyModel(
                cheese, "milkTypes"), // #1
                choices)); // #2
        ...
        add(new CheckBoxMultipleChoice("milkTypes2", new PropertyModel(
                cheese, "milkTypes"), choices).setSuffix(" "));

    /* Section 7.4.3 */

        List<MilkType> milktypes = Arrays.asList(
                new MilkType(1, "Camel"), new MilkType(2, "Cow"),
                new MilkType(3, "Goat"));
    ...
    /* Section 7.4.4 */
        ...
        add(new CheckBox("wantsspam",
                new PropertyModel(cust, "wantsspam")));
        ...
        Form form = new Form("form744", new CompoundPropertyModel(
                searchPars)) {
            @Override
        ...
        form.add(wmc);
        form.add(new AjaxCheckBox("advanced", new PropertyModel(wmc,
                "visible")) {
            @Override
        ...
        wmc.add(new CheckBoxMultipleChoice("milktypes",
                new MilkTypesModel()).setPrefix("").setSuffix(""));
    }
}
